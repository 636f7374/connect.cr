  ...
  private def create_outbound_socket!(session : Session, request : HTTP::Request, destination_frame : CONNECT::Frames::Destination) : TCPSocket
    ...
    begin
      ...
      in Address
        ...
        socket = TCPSocket.new host: destination_address.host, port: destination_address.port, dns_resolver: dns_resolver, delegator: nil, connect_timeout: outbound_timeout.connect
